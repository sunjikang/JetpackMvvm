...
import me.hgj.jetpackmvvm.demo.app.ext.initSmain
...
import me.hgj.jetpackmvvm.demo.databinding.FragmentSmainBinding
 ...
 * 描述　:项目主页Fragment
 */
class SmainFragment : BaseFragment<MainViewModel, FragmentSmainBinding>() {

    override fun initView(savedInstanceState: Bundle?) {
        //初始化viewpager2
        mainViewpager.initSmain(this)
        //初始化 bottomBar
        mainBottom.init{
            when (it) {
